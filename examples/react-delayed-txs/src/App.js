...
function App() {
  ...
  async function delay() {
    // the call to delay
    let balanceTransfer = etf.api.tx.balances
      .transferKeepAlive('5FHneW46xGXgs5mUiveU4sbTyGBzmstUspZC92UhjJM694ty', 1_000_000_000);
    ...
    etf.delay(balanceTransfer, deadline, "testSeed").then(async outerCall => {
      console.log('delayed call created: ' + JSON.stringify(outerCall.toHuman()))
